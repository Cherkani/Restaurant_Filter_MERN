...
const Home = () => {
  ...
  const [cities, setCities] = useState([
    { id: 1, checked: false, label: "casablanca" },
  ...
  const [zone, setZone] = useState([
    { id: 1, checked: false, label: "maarif", id2: 1 },
  ...
  // const [list, setList] = useState([]); // Initialisez list avec un tableau vide
  ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "http://127.0.0.1:3000/api/restaurants"
        );
